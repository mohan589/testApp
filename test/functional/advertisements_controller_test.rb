...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { add_cost: @advertisement.add_cost, description: @advertisement.description, pramotor: @advertisement.pramotor, title: @advertisement.title }
    end
  ...
  test "should update advertisement" do
    put :update, id: @advertisement, advertisement: { add_cost: @advertisement.add_cost, description: @advertisement.description, pramotor: @advertisement.pramotor, title: @advertisement.title }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
